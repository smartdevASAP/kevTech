...
function Card({ item }) {
  ...
  return (
    <div className="mt-16 md:flex md:align-top gap-0">
      ...
      <div className=" bg-indigo-50/2 p-4 rounded-sm ">
        ...
        <div className="flex gap-8">
          <button className="p-2 shadow-sm shadow-gray-200 rounded-sm bg-primary text-white">
            Book Service
          </button>
          <button className="p-2 shadow-sm shadow-gray-200 rounded-sm text-gray-600">
            Make enquiry
          </button>
        </div>
      </div>
